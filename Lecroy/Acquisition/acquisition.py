...
# lecroy = rm.open_resource('TCPIP0::192.168.0.170::INSTR') #, resource_pyclass=MessageBasedResource) # The old oscilloscope
# lecroy = rm.open_resource('TCPIP0::192.168.0.170::inst0::INSTR', resource_pyclass=MessageBasedResource) # The new oscilloscope
# lecroy = rm.open_resource('TCPIP0::169.254.63.16::inst0::INSTR', resource_pyclass=MessageBasedResource) # The new oscilloscope
lecroy = rm.open_resource('TCPIP::169.254.224.75::hislip0,4880::INSTR', resource_pyclass=MessageBasedResource) # KEYSIGHT oscilloscope
# lecroy = rm.open_resource('TCPIP0::255.255.0.0::inst0::INSTR', resource_pyclass=MessageBasedResource) # The new oscilloscope
lecroy.timeout = 3000000
lecroy.encoding = 'latin_1'
lecroy.clear()
# print(rm.open_resource('TCPIP0::192.168.0.169::inst0::INSTR').query('*IDN?'))
# lecroy.query('*IDN?')
# lecroy.write('*IDN?')
# lecroy.write("SEQ ON,1000")
...
print("\n\n  -------------  BetrigChginning save waveforms.  ----------------------")
